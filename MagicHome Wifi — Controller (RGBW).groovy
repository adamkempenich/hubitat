/**
 *  MagicHome Wifi - Controller (RGBW) 0.82
 *
 *  Author: 
 *    Adam Kempenich 
 *
...
def setWhiteLevel( whiteLevel, transmit=true){
    ...
    logDebug( "WhiteLevel set to ${whiteLevel}")
    
    if( !transmit ) return whiteLevel
    setColor( [ hue: 100, level: whiteLevel ] )
}
